			...
			<div class="container">
					...
					<div class="col-lg-6 col-md-12">
						<div class="content-wrapper">
							...
							<h2 class="page-headline">
								<?php the_field('marketing1'); ?>
							</h2>
							<?php the_field('text1'); ?>
							<a class="custom-btn" href="https://backoffice.verumtrade.com/sign_up" target="_blank"><span>Стать партнером</span>
				...
				<div class="second-block">
					<div class="row">
						<div class="col-sm-12">
							...
							<h2 class="page-headline ta-c"><?php the_field('marketing2'); ?></h2>
				...
				<div class="row third-block">
					<div class="col-lg-6 col-md-12">
						...
						<h2 class="page-headline">
						<?php the_field('cm_mrk'); ?> </h2>
					  <?php the_field('cm_text'); ?>
					</div>
					<div class="col-lg-6 col-md-12"><img src="./images/credit-card.png" alt="credit card" style="width: 525px; height: 501px;"></div>
				</div>
